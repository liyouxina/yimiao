var t = require("../../../../F1EEC043AB6B1EDF9788A844C16B09F3.js"), a = getApp();
...
Page({
    ...
    onLoad: function(t) {
        console.log(t), t.id ? a.globalData.subscribeInfo.customerId = decodeURIComponent(t.id) : wx.navigateBack();
    },
